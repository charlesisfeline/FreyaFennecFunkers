...
class PlayState extends MusicBeatSubState
{
  ...
  **/
  ...
  /**
   * The current 'Death Counter' to display in the pause menu.
  ...
  **/
  ...
  public override function closeSubState():Void
  {
    if (Std.isOfType(subState, PauseSubState))
    {
      ...
      #if discord_rpc
      if (Countdown.countdownStep == AFTER) DiscordClient.changePresence(detailsText, '${currentChart.songName} ($storyDifficultyText)', iconRPC, true,
  ...
  override function stepHit():Bool
  {
    ...
    {
      #if debug trace("resyncing vocals!!!"); #end
  ...
  function debugKeyShit():Void
  {
    ...
    perfectMode = false;
    #else
    if (FlxG.keys.justPressed.H) camHUD.visible = !camHUD.visible; // Why don't I just make this an option instead like, come on.
    #end
  ...
  function applyScore(score:Int, daRating:String, healthChange:Float, isComboBreak:Bool)
  {
    ...
    if (isComboBreak)
    {
      ...
      if (Highscore.tallies.combo >= 70) currentStage.getGirlfriend().playAnimation('drop70', true);
