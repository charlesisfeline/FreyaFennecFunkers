...
class ChartEditorThemeHandler
{
  ...
  // ================================
  static final BACKGROUND_COLOR_LIGHT:FlxColor = 0xFFF3964A;
  static final BACKGROUND_COLOR_DARK:FlxColor = 0xFF533B17;
  ...
  static final NOTE_PREVIEW_VIEWPORT_BORDER_COLOR_LIGHT = 0xFFF8DB57;
  static final NOTE_PREVIEW_VIEWPORT_BORDER_COLOR_DARK = 0xFFF8DB57;
